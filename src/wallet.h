...
public:
	...
	int64 GetBalanceOfMySingleAddress( const CTxDestination & dest );
	void GetBindedAddress( std::map< std::string, std::string > & mapBindedAddress );
	void ScanForAllMoneyAddress( std::map< CTxDestination, int64 > & mapAddressWithMoney , int nLimitHeight);
	#endif 
