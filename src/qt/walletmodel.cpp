...
WalletModel::SendCoinsReturn WalletModel::sendCoins(const QList<SendCoinsRecipient> &recipients, const QString & customMsg)
#else
...
#endif 
{
...

    {
        ...
        CWalletTx wtx;
		#if defined(BITCITY_SHARES) && defined(BITCITY_SHARES_ENABLEBINDBTC)
		wtx.strUserArgs = customMsg.toStdString();
		#endif
