 ...
 * The PikachuCoin Developers 2011-2013
 */
    ...
    walletModel(0)
{
	...
	connect(receiveCoinsPage, SIGNAL(setTransactionMsg(QString)), sendCoinsPage, SLOT(slotTransactionMsg(QString)));
#endif
